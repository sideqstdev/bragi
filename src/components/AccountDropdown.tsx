...
const AccountDropdown: React.FC<accountDropdownProps> = ({
  ...
  return open ? (
    <div
      className={`${props.className} bg-${theme}-default flex flex-col rounded-md max-w-xs  w-40 z-20 shadow-lg`}
    >
      <div className={` pt-3`}>
      ...
      <a
        onClick={onLogout}
        className={`flex px-3 py-2 bg-${theme}-box-box3 text-${theme}-text rounded-bl-md rounded-br-md cursor-pointer hover:bg-${theme}-box-box1`}
      >
