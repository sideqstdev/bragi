...
export const XXLHeader: React.FC<typographyProps> = ({
  children,
  isBold,
  ...props
}: typographyProps) => {
...
export const XLHeader: React.FC<typographyProps> = ({
  children,
  isBold,
  ...props
}: typographyProps) => {
...
export const LGHeader: React.FC<typographyProps> = ({
  children,
  isBold,
  ...props
}: typographyProps) => {
...
export const MDHeader: React.FC<typographyProps> = ({
  children,
  isBold,
  ...props
}: typographyProps) => {
...
export const SMHeader: React.FC<typographyProps> = ({
  children,
  isBold,
  ...props
}: typographyProps) => {
...
export const XSHeader: React.FC<typographyProps> = ({
  children,
  isBold,
  ...props
}: typographyProps) => {
...
export const SMParagraph: React.FC<typographyProps> = ({
  children,
  isBold = false,
  ...props
}: typographyProps) => {
