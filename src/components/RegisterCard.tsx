        ...
        <Card className={`flex flex-col w-full mx- md:w-3/4 md:flex-row lg:w-2/4 xl:w-2/6 px-3 py-3`}>
            {otherLoginMethods ? (
                ...
                <form autoComplete={"off"} onSubmit={registerForm.handleSubmit} className={`w-full border-b-2 pb-6 border-dark-box-box4 md:pr-3 md:border-b-0 md:border-r-2 md:border-dark-box-box4 md:w-2/3`}>
                    ...
                    <Input autoComplete={"new-password"} id={`confirm-password`} onChange={registerForm.handleChange} name={`confirmPassword`} error={registerForm.errors.confirmPassword} iconLeft={<FiLock/>} type={`password`} className={`mt-2`} label={`Confirm Password`} stretch={true} placeholder={`repeat password`}/>
